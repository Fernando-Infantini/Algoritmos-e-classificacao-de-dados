...
class BTreeNode {
	...
	*/
    ...
    void removeFromInternal(int idx) {
        ...
        System.out.println("-> removeFromInternal(): removendo chave interna " + keys[idx]);
    ...
    int getPredecessor(int idx) {
        ...
        while (!cur.leaf)
            ...
            System.out.println("-> getPredecessor(): utilizando o predecessor como substituto");
    ...
    int getSuccessor(int idx) {
        ...
        while (!cur.leaf)
            cur = cur.children[0];
            System.out.println("-> getSuccessor(): utilizando o sucessor como substituto");
        return cur.keys[0];
    }
    ...
    void fill(int idx) {
        ...
        System.out.println("-> fill(): garantindo mínimo de chaves no filho " + idx);
    ...
    void borrowFromPrev(int idx) {
        ...
        System.out.println("-> borrowFromPrev(): emprestando chave do irmão à esquerda");
    ...
    void borrowFromNext(int idx) {
        ...
        System.out.println("-> borrowFromNext(): emprestando chave do irmão à direita");
    ...
    void merge(int idx) {
        ...
        System.out.println("-> merge(): realizando fusão dos nós em torno da chave " + keys[idx]);
...
public class BTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Árvore depois de algumas inserções:");
        tree.print();
        ...
        do {
            System.out.print("Digite chave a inserir (0 para sair): ");
            chave = sc.nextInt();
            if (chave != 0) {
                tree.insert(chave);
                tree.print();
